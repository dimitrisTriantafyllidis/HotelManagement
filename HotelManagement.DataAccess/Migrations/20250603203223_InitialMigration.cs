        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PdfFileBlob = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    SubmittedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BookingId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnlineCheckInForms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OnlineCheckInForms_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnlineCheckInForms_BookingId",
                table: "OnlineCheckInForms",
                column: "BookingId",
                unique: true,
